shinyUI(fluidPage(
        ...
        sidebarLayout(sidebarPanel(
                ...
                helpText("Estimate the probability of a vehicle having a `V-engine` or a `straight engine` using the a weight (1000 lbs) and engine displacement values (cu. inches)"),
